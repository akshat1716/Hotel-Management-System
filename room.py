...
class Booking_Room():
    def __init__(self,root):
        ...
        conn=mysql.connector.connect(host="localhost",username="root",password="thespider20",database="mydata")
    ...
    def cont_fetch(self):
        if self.var_mobile.get()=="":
            ...
            conn=mysql.connector.connect(host="localhost",user="root",password="thespider20",database="mydata")
            my_cursor=conn.cursor()

...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        img1=Image.open(r"images\hotel 1.jpg")
        ...
        title_lbl=Label(self.root,text="HOTEL MANAGEMENT SYSTEM",font=("times new roman",40,"bold"),bg="black",fg="white",bd=3,relief=RIDGE)
        ...
        lbl = Label(title_lbl, font = ('times new roman',17, 'bold'),background = 'black',foreground = 'white') 
        lbl.place(x=0,y=0,width=140) 
        time() 

        img3=Image.open(r"images\slide 3.jpg")
        ...
        menu_lbl=Label(main_frame,text="MENU",font=("times new roman",20,"bold"),bg="black",fg="white")
        menu_lbl.place(x=0,y=0,width=228)
        ...
        add_cust=Button(btn_frame,text="CUSTOMER",bd=0,width=22,command=self.cust_details_win,font=("times new roman",14,"bold"),bg="black",fg="white",cursor="hand2")
        add_cust.grid(row=0,column=0,pady=1)

        add_cust=Button(btn_frame,text="BOOKING",bd=0,relief=RIDGE,width=22,command=self.booking_room,font=("times new roman",14,"bold"),bg="black",fg="white",cursor="hand2")
        add_cust.grid(row=1,column=0,pady=1)

        add_cust=Button(btn_frame,text="DETAILS",bd=0,relief=RIDGE,width=22,command=self.details_add,font=("times new roman",14,"bold"),bg="black",fg="white",cursor="hand2")
        add_cust.grid(row=2,column=0,pady=1)

        add_cust=Button(btn_frame,text="REPORT",bd=0,relief=RIDGE,width=22,font=("times new roman",14,"bold"),bg="black",fg="white",cursor="hand2")
        add_cust.grid(row=3,column=0,pady=1)

        add_cust=Button(btn_frame,text="LOGOUT ",command=self.return_login,bd=0,relief=RIDGE,width=22,font=("times new roman",14,"bold"),bg="black",fg="white",cursor="hand2")
